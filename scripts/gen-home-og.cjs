...
;(async () => {
  ...
  }, { tag: 'Free · No signup · Client-side', title: 'Developer Tools\nthat just work', subtitle: 'JSON · Converters · Text & Code · Security · Dev Utils', size: 60 });

  await page.waitForTimeout(200);
  await page.screenshot({ path: path.join(OUT_DIR, 'og-image.png'), type: 'png' });
  await browser.close();
  console.log('Done — og-image.png (homepage)');
})();
