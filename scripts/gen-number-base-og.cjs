...
;(async () => {
  ...
  }, { tag: 'Dev Util', title: 'Number Base Converter', subtitle: 'Binary, Octal, Decimal, Hexadecimal\n— instant conversion with prefix detection.', size: 62 });

  await page.waitForTimeout(200);
  await page.screenshot({ path: path.join(OUT_DIR, 'number-base.png'), type: 'png' });
  await browser.close();
  console.log('Done — number-base.png');
})();
