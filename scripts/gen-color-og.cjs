...
;(async () => {
  ...
  }, { tag: 'Dev Utils', title: 'Color Picker & Converter', subtitle: 'HEX · RGB · HSL · HSB conversion + WCAG contrast checker.\nFree · No data sent to servers.', size: 60 });

  await page.waitForTimeout(200);
  await page.screenshot({ path: path.join(OUT_DIR, 'color.png'), type: 'png' });
  await browser.close();
  console.log('Done — color.png');
})();
