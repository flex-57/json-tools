...
;(async () => {
  ...
  }, { tag: 'JSON', title: 'JSON Formatter & Validator', subtitle: 'Format, validate, and minify JSON instantly.\nFree · No data sent to servers.', size: 64 });

  await page.waitForTimeout(200);
  await page.screenshot({ path: path.join(OUT_DIR, 'json-formatter.png'), type: 'png' });
  await browser.close();
  console.log('Done — json-formatter.png');
})();
