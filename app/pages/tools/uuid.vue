  ...
  <div class="page">
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">Generate random UUID v4, time-sortable UUID v7 or ULID identifiers instantly, client-side. Choose format, bulk-generate up to 100, copy individually or all at once.</p>
