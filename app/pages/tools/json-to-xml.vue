  ...
  <div class="page">
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">Convert a JSON object to XML, entirely in your browser.</p>
      </div>
      ...
      <div class="pane" :class="{ 'pane--drag': isDragging, 'pane--invalid': error }" @dragover.prevent="isDragging = true" @dragleave="isDragging = false" @drop.prevent="onDrop">
        <div class="pane-header">
          ...
          <div class="card-actions">
            <label class="btn-xs" for="json-to-xml-file-input">
            ...
            <input id="json-to-xml-file-input" type="file" accept=".json,application/json" class="file-input" @change="onFileInput" >
      ...
      <div class="pane pane--alt">
        ...
        <div class="pane-body" :class="{ 'pane-body--empty': !output }" :style="output ? 'padding: 0;' : ''" aria-live="polite">
          <Transition name="reveal" mode="out-in">
            <p v-if="!output" key="empty" class="pane-body-placeholder">{{ input.trim() ? 'Fix the error in your input to see XML output' : 'XML output will appear here…' }}</p>
