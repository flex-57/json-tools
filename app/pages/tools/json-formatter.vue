      ...
      <div class="pane" :class="{ 'pane--drag': isDragging, 'pane--invalid': error }" @dragover.prevent="isDragging = true" @dragleave="isDragging = false" @drop.prevent="onDrop">
        <div class="pane-header">
          ...
          <div class="card-actions">
            <label class="btn-xs" for="json-formatter-file-input">
            ...
            <input id="json-formatter-file-input" type="file" accept=".json,application/json" class="file-input" @change="onFileInput" >
