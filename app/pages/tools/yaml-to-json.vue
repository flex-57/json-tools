  ...
  <div class="page">
    <div class="page-header">
      <div>
        ...
        <p class="page-subtitle">Convert YAML to JSON, entirely in your browser.</p>
      ...
      <div class="pane" :class="{ 'pane--drag': isDragging, 'pane--invalid': error }" @dragover.prevent="isDragging = true" @dragleave="isDragging = false" @drop.prevent="onDrop">
        <div class="pane-header">
          ...
          <div class="card-actions">
            <label class="btn-xs" for="yaml-to-json-file-input">
            ...
            <input id="yaml-to-json-file-input" type="file" accept=".yaml,.yml,text/yaml" class="file-input" @change="onFileInput" >
