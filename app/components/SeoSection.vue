...
const AUTO_RELATED: Record<string, string[]> = {
  ...
  '/tools/toml-to-json':   ['/tools/json-to-toml', '/guides/what-is-toml', '/tools/yaml-to-json'],
  '/tools/json-to-toml':   ['/tools/toml-to-json', '/guides/what-is-toml', '/tools/json-to-yaml'],
  '/tools/json-diff':      ['/tools/json-formatter', '/tools/json-tree', '/tools/json-schema'],
  '/tools/json-tree':      ['/tools/json-graph', '/tools/json-formatter', '/tools/json-diff'],
  '/tools/json-graph':     ['/tools/json-tree', '/tools/json-formatter', '/tools/json-diff'],
  ...
  '/tools/hash':           ['/guides/what-is-hash', '/tools/hmac', '/tools/uuid', '/guides/encoding-vs-encryption-vs-hashing'],
  '/tools/hmac':           ['/tools/hash', '/guides/what-is-hmac', '/tools/jwt-generator'],
  ...
  '/tools/css-minifier':   ['/tools/html-minifier', '/tools/js-minifier', '/tools/gradient', '/guides/what-is-minification'],
  '/tools/html-minifier':  ['/tools/css-minifier', '/tools/js-minifier', '/tools/markdown-preview', '/guides/what-is-minification'],
  '/tools/js-minifier':    ['/tools/css-minifier', '/tools/html-minifier', '/tools/json-formatter', '/guides/what-is-minification'],
  '/tools/svg-optimizer':  ['/tools/svg-to-jsx', '/guides/what-is-svg', '/tools/css-minifier'],
  '/tools/svg-to-jsx':     ['/tools/svg-optimizer', '/guides/what-is-svg', '/tools/json-to-ts'],
  '/tools/sql-formatter':  ['/tools/js-minifier', '/tools/json-formatter', '/tools/regex-tester', '/guides/sql-cheatsheet'],
  '/tools/graphql-formatter':  ['/tools/sql-formatter', '/guides/what-is-graphql', '/tools/json-formatter'],
  '/tools/text-case':          ['/tools/url-encode', '/tools/css-minifier', '/tools/regex-tester'],
  '/tools/string-escape':      ['/tools/json-formatter', '/tools/base64', '/tools/url-encode'],
  ...
  '/tools/color':          ['/tools/gradient', '/tools/box-shadow', '/tools/uuid', '/guides/understanding-color-formats'],
  '/tools/gradient':       ['/tools/color', '/tools/box-shadow', '/guides/understanding-color-formats'],
  '/tools/box-shadow':     ['/tools/gradient', '/tools/color'],
  '/tools/og-generator':   ['/guides/what-is-open-graph'],
  '/tools/gpt-token-counter': ['/guides/what-is-a-token', '/tools/json-formatter'],
  '/tools/jwt-generator':  ['/tools/jwt-decoder', '/guides/what-is-jwt', '/tools/hmac'],
}
