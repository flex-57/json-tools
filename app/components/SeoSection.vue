...
const AUTO_RELATED: Record<string, RelatedTool[]> = {
  '/tools/json-formatter': [{ label: 'JSON Diff', to: '/tools/json-diff' }, { label: 'JSON Tree', to: '/tools/json-tree' }, { label: 'JSON → TypeScript', to: '/tools/json-to-ts' }],
  ...
  '/tools/xml-to-json':    [{ label: 'JSON → XML', to: '/tools/json-to-xml' }, { label: 'YAML → JSON', to: '/tools/yaml-to-json' }, { label: 'JSON Formatter', to: '/tools/json-formatter' }],
  '/tools/json-to-xml':    [{ label: 'XML → JSON', to: '/tools/xml-to-json' }, { label: 'JSON → YAML', to: '/tools/json-to-yaml' }, { label: 'JSON Formatter', to: '/tools/json-formatter' }],
  '/tools/yaml-to-json':   [{ label: 'JSON → YAML', to: '/tools/json-to-yaml' }, { label: 'XML → JSON', to: '/tools/xml-to-json' }, { label: 'JSON Formatter', to: '/tools/json-formatter' }],
  '/tools/json-to-yaml':   [{ label: 'YAML → JSON', to: '/tools/yaml-to-json' }, { label: 'JSON → XML', to: '/tools/json-to-xml' }, { label: 'JSON Formatter', to: '/tools/json-formatter' }],
  ...
  '/tools/json-schema':    [{ label: 'JSON → TypeScript', to: '/tools/json-to-ts' }, { label: 'JSON Formatter', to: '/tools/json-formatter' }, { label: 'JSON Diff', to: '/tools/json-diff' }],
  ...
  '/tools/uuid':                [{ label: 'Hash Generator', to: '/tools/hash' }, { label: 'Password Generator', to: '/tools/password-generator' }],
