...
const AUTO_RELATED: Record<string, string[]> = {
  ...
  '/tools/css-minifier':   ['/tools/html-minifier', '/tools/js-minifier', '/tools/gradient', '/tools/color'],
  '/tools/html-minifier':  ['/tools/css-minifier', '/tools/js-minifier', '/tools/markdown-preview'],
  '/tools/js-minifier':    ['/tools/css-minifier', '/tools/html-minifier', '/tools/json-formatter', '/tools/regex-tester'],
