...
.rules-valid code  { font-family: 'JetBrains Mono', monospace; font-size: 12px; color: #16A34A; background: rgba(22, 163, 74, 0.08); padding: 1px 5px; border-radius: 4px; }
.rules-invalid code { font-family: 'JetBrains Mono', monospace; font-size: 12px; color: #DC2626; background: rgba(220, 38, 38, 0.08); padding: 1px 5px; border-radius: 4px; }
